...
HD_PWD='C:/Users/l/Desktop/6463ADVHDes/code/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rotate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rotate.tcl
